    ...
    keys = {
      ...
      },
      {
        ...
        function()
          ...
          vim.notify("Replaced slot 1", vim.log.levels.INFO)
        end,
      ...
      },
      {
        ...
        function()
          ...
          vim.notify("Replaced slot 2", vim.log.levels.INFO)
        end,
      ...
      },
      {
        ...
        function()
          ...
          vim.notify("Replaced slot 3", vim.log.levels.INFO)
        end,
      ...
      },
      {
        ...
        function()
          ...
          vim.notify("Replaced slot 4", vim.log.levels.INFO)
        end,
      ...
      },
      {
        ...
        function()
          ...
          vim.notify("Replaced slot 5", vim.log.levels.INFO)
        end,
        desc = "Harpoon: Replace at 5",
      },
    },
    opts = {
      settings = {
